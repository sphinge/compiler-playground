...
SDDHash = {
    "PROGRAM": {"DECLARATION": (inherit_next_2_children, synth_code_2_children)},
    "PROGRAMX": {
    ...
    "ASSIGNMENT": {"TYPE": (inherit_next_to_last_child, ASSIGNMENT_synth)},
    "EXPRSTMT": {"EXPRESSION": (inherit_next_1_child, EXPRSTMT_synth)},
    "IFSTMT": {"if": (IFSTMT_inherit, IFSTMT_synth)},
    "IFSTMTX": {
    ...
    "PARAMETERSX": {"epsilon": "$$$$", ",": "$$$$"},
    "ARGUMENTS": {"EXPRESSION": (None, ARGS_synth)},
    "ARGUMENTSX": {",": (None, ARGSX_synth), "epsilon": (None, synth_code_epsilon)},
    "EXPRESSION": {"ELEVEL1": (EXPR_inherit, EXPR_bool_highest_add_gotos)},
    "EXPRESSIONX": {
        "or": (EXPR_inherit, EXPRX_synth),
        "epsilon": (None, synth_code_epsilon),
    },
    "ELEVEL1": {"ELEVEL2": (EXPR_inherit, EXPR_bool_synth)},
    "ELEVEL1X": {
        "and": (EXPR_inherit, EXPRX_synth),
        "epsilon": (None, synth_code_epsilon),
    },
    "ELEVEL2": {"ELEVEL3": (EXPR_inherit, EXPR_bool_synth)},
    "ELEVEL2X": {
        "==": (EXPR_inherit, EXPRX_synth),
        "epsilon": (None, synth_code_epsilon),
    },
    "ELEVEL3": {"ELEVEL4": (EXPR_inherit, EXPR_bool_synth)},
    "ELEVEL3X": {
        "COMPOPERATORS": (None, EXPRX3_synth),
        "epsilon": (None, synth_code_epsilon),
    },
    "ELEVEL4": {"ELEVEL5": (EXPR_inherit, EXPR_number_synth)},
    "ELEVEL4X": {
        "+": (EXPR_inherit, EXPRX_synth),
        "-": (EXPR_inherit, EXPRX_synth),
        "epsilon": (None, synth_code_epsilon),
    },
    "ELEVEL5": {"ELEVEL6": (EXPR_inherit, EXPR_number_synth)},
    "ELEVEL5X": {
        "/": (EXPR_inherit, EXPRX_synth),
        "*": (EXPR_inherit, EXPRX_synth),
        "epsilon": (None, synth_code_epsilon),
    ...
    "FUNCCALLORVARIABLE": {"identifier": (EXPR_inherit, VARORCALL_synth)},
    "FUNCCALLX": {"(": (None, FUNCX_synth), "epsilon": (None, synth_code_epsilon)},
    "COMPOPERATORS": {
        "<=": (None, COMPOP_synth),
        "<": (None, COMPOP_synth),
        ">": (None, COMPOP_synth),
